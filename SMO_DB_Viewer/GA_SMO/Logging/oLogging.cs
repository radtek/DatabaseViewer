...
namespace GA_SMO
{
    ...
    public class LogFile : IDisposable
    {
        ...
        public LogFile()
            : this("", false, LogFileNamingType.Standard)
        {
        }

        public LogFile(string logFilePath)
            : this(logFilePath, false, LogFileNamingType.Standard)
        {
        ...
        public static string GetDateStampedFileName(string fileName)
        {
            ...
            fileName += DateStamp.GetDateStamp() + ext;
    ...
    public static class DateStamp
    {
        ...
        {
            return "_" + DateTime.Now.Month.ToString("00") + DateTime.Now.Day.ToString("00") + DateTime.Now.Year.ToString("0000") + DateTime.Now.Hour.ToString("00") + DateTime.Now.Minute.ToString("00") + DateTime.Now.Second.ToString("00");
        }
    }

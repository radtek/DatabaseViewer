...
namespace VTAServiceCheck.Logging
{
  public delegate void MessageLoggedDelegate(object sender, EventLog.LogMessageEventArgs e);
  ...
  public class LogFile : IDisposable
  {
    ...
    public void WriteBlankLines(int lines)
    {
      ...
      for (int i = 0; i <= lines - 1; i++)
      {
        ...
        if (MessageLoggedEvent != null)
          MessageLoggedEvent(this, new EventLog.LogMessageEventArgs(""));
      }
    }
    ...
    public void WriteLogMessage(string message, bool omitTimeStamp)
    {
      ...
      try
      {
        ...
        if (MessageLoggedEvent != null)
          MessageLoggedEvent(this, new EventLog.LogMessageEventArgs(message));

...
namespace ScintillaNet
{
    internal static class NativeMethods
    {
        ...
        internal extern static IntPtr GetSystemDirectory([Out] StringBuilder outBuffer, int outBufferSize);

        [DllImport("kernel32", SetLastError = true)]
        internal extern static IntPtr LoadLibrary(string lpLibFileName);

        [DllImport("kernel32", SetLastError = true)]
        internal extern static bool SetDllDirectory(string lpDllDirLocation);
